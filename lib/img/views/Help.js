    ...
    return (React.createElement(HTML, { style: { width: `${width + 60}px`, background: '#faf6ed' } },
        React.createElement("div", { style: {
            ...
            React.createElement("div", { style: {
                    ...
                    background: 'radial-gradient(circle at 15% 12%, rgba(255, 227, 170, 0.48), transparent 26%), radial-gradient(circle at 85% 18%, rgba(218, 181, 120, 0.2), transparent 28%), linear-gradient(180deg, rgba(250, 246, 237, 0.98) 0%, rgba(244, 235, 218, 0.98) 100%)',
                    borderRadius: '20px',
