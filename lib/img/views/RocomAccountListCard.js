...
function RocomAccountListCard({ data }) {
                    ...
                    data.bindings.length > 0 ? (React.createElement("main", { style: { display: 'flex', flexDirection: 'column', gap: '15px', marginBottom: '20px' } }, data.bindings.map(item => (React.createElement("div", { key: `${item.index}-${item.roleId}-${item.tgpId}`, style: {
                        ...
                        React.createElement("div", { style: { flex: 1, paddingLeft: '10px' } },
                            ...
                            React.createElement("div", { style: {
                                ...
                                React.createElement("span", { style: { fontWeight: 500, color: '#5f4d33' } }, item.roleId),
                            ...
                            React.createElement("div", { style: {
                                ...
                                React.createElement("span", { style: { opacity: 0.7, marginRight: '4px', whiteSpace: 'nowrap' } }, "\u767B\u5F55\u65B9\u5F0F"),
                                React.createElement("span", { style: { fontWeight: 500, color: '#5f4d33' } }, item.loginType),
                                React.createElement("span", { style: { opacity: 0.7, marginRight: '4px', marginLeft: '15px', whiteSpace: 'nowrap' } }, "\u7B49\u7EA7"),
                                React.createElement("span", { style: { fontWeight: 500, color: '#5f4d33' } }, item.levelText),
                                React.createElement("span", { style: { opacity: 0.7, marginRight: '4px', marginLeft: '15px', whiteSpace: 'nowrap' } }, "\u661F\u7EA7"),
                                React.createElement("span", { style: { fontWeight: 500, color: '#5f4d33' } }, item.starName))),
                        React.createElement("div", { style: {
                                display: 'flex',
