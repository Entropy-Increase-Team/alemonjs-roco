...
import { requestWeGame, resolveActiveWeGameCredential } from './wegameAccount.js';
...
async function resolveRocomUid(context, rawArgs, emptyMessage) {
...
async function getRocomHome(context, rawArgs = '') {
...
async function getRocomRecord(context, rawArgs = '') {
