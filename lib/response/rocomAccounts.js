import { getRocomAccounts, buildRocomAccountsCardData, buildRocomAccountsText } from '../model/rocomAccount.js';
import RocomAccountListCard from '../img/views/RocomAccountListCard.js';
import { getWeGameUserContext } from '../model/wegameAccount.js';
import { useEvent, useMessage, Format } from 'alemonjs';
import { renderComponentIsHtmlToBuffer } from 'jsxp';

var rocomAccounts = async () => {
...
export { rocomAccounts as default };
