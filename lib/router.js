...
baseGroup.use(['roco帮助', 'rocohelp'], () => import('./response/help.js'));
baseGroup.use(['洛克帮助', '洛克help'], () => import('./response/help.js'));
...
baseGroup.use(['wg帮助', 'wghelp'], () => import('./response/help.js'));
...
rocoQuickGroup.use(['帮助', 'help'], () => import('./response/help.js'));
