                ...
                {data.bindings.map(item => (
                  ...
                  >
                    ...
                    <div style={{ flex: 1, paddingLeft: '10px' }}>
                      ...
                      >
                        <span style={{ opacity: 0.7, marginRight: '4px', whiteSpace: 'nowrap' }}>状态</span>
                        <span style={{ fontWeight: 500, color: '#5f4d33' }}>{item.statusText}</span>
                        <span style={{ opacity: 0.7, marginRight: '4px', marginLeft: '15px', whiteSpace: 'nowrap' }}>登录方式</span>
                      ...
                      >
                        ...
                        <span style={{ fontWeight: 500, color: '#5f4d33' }}>{item.roleId || '未返回'}</span>
